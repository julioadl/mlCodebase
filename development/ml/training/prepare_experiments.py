...
def run_experiments(experiments_filename):
    ...
    for ind in range(num_experiments):
        ...
        print(f"python3.6 run_experiment.py --gpu=-1 '{json.dumps(experiment_config)}'")

if __name__=='__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument("experiments_filename", type=str, help="Filename of JSON file experiments to run")
